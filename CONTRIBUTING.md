...
When you submit a pull-request, a CLA bot will automatically determine whether or not you need to agree to the CLA and decorate the PR appropriately (e.g., status check, comment). If available, follow the instruction provided by the bot. You will only need to do this once across all repositories using the Jarsoft CLA.
